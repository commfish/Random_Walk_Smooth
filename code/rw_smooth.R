...
# Function inputs: 
# s.yr		= survey years
# b		= observed biomasses
# cv.b		= survey cvs
# sigma		= process error (random walk standard deviation on log scale)
#
...
# Negative log likelihood function wrt predicted survey biomass b.hat
